    ...
    <div className="App">
          ...
          <div className="stats-heading">
            ...
            <p>
              <FontAwesomeIcon
                ...
                style={{ color: "#2F8A5F" }}
              ></FontAwesomeIcon>{" "}
              <span style={{ color: "#2F8A5F", fontWeight: "bolder" }}>
                16%
              </span>{" "}
              this month
            </p>
          ...
          <div className="stats-heading">
            ...
            <p>
              <FontAwesomeIcon
                ...
                style={{ color: "#C5255D" }}
              ></FontAwesomeIcon>{" "}
              <span style={{ color: "#C5255D", fontWeight: "bolder" }}>1%</span>{" "}
              this week
            </p>
          </div>
          <div>
      ...
      <div className="table-container">
        <div className="sort-container">
          ...
          <div>
            <div
              style={{ backgroundColor: "#FAFBFF", padding: "2px 5px" }}
              className="search"
            >
              <FontAwesomeIcon
                style={{ color: "#8F9094" }}
        ...
        <div className="data-container">
          ...
          <div className="pagination">
            ...
            <a href="No link" className="page-link page-link--current">
              1
            </a>
            <a href="No link" className="page-link">
              2
            </a>
            <a href="No link" className="page-link">
              3
