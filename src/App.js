...
function App() {
  ...
  return (
      ...
      <div className="header d-flex justify-content-around  col-12">
        ...
        <div className="navigation d-flex justify-content-center  col-8">
          ...
          <ul>
            ...
            <li>
              <FontAwesomeIcon style={{color: "#A2A2A2"}} className="faItem fa-xl" icon={faGear} />
            </li>
            <li>
              <FontAwesomeIcon style={{color: "#A2A2A2"}} className="faItem fa-xl" icon={faClock} />
            </li>
            <li>
              <FontAwesomeIcon style={{color:"#505050"}} className="faItem fa-xl" icon={faBell} />
            </li>
            <li>
              <img
                src="./profile.png"
      ...
      <h5 className="ms-4 mb-2">Hello Nile 👏</h5>
        <div className=" col-12 d-flex justify-content-between align-items-center  bg-white p-3 rounded-5">
          <div className="col-md-4 d-flex justify-content-center align-items-center gap-4">
            <div>
              <FontAwesomeIcon  style={{color:"#599778",borderRadius:"50%",backgroundColor:"#D5FFED", width:"80px", height: "40px",padding:"10px"}} className="fa-2xl" icon={faSackDollar} />
            </div>
            <div>
              <h5 style={{ margin: "0px", fontWeight: "lighter", fontSize: "14px" }}>Earning</h5>
          ...
          <div className="col-md-4 d-flex justify-content-center align-items-center gap-4">
            <div>
              <FontAwesomeIcon style={{color:"#3471AA",borderRadius:"50%",backgroundColor:"#C9F1FF", width:"80px", height: "40px",padding:"10px"}} className="fa-2xl" icon={faSackDollar} />
            </div>
            <div>
              <h5 style={{ margin: "0px", fontWeight: "lighter", fontSize:"14px" }}>Earning</h5>
              <h3 style={{ margin: "0px" }}>$198k</h3>
          ...
          <div className="col-md-4 d-flex justify-content-center align-items-center gap-4">
            <div>
              <FontAwesomeIcon style={{color:"#A73759",borderRadius:"50%",backgroundColor:"#FFC2EC", width:"80px", height: "40px",padding:"10px"}} className="fa-2xl" icon={faSackDollar} />
            </div>
            <div>
              <h5 style={{ margin: "0px", fontWeight: "lighter", fontSize: "14px" }}>Earning</h5>
              <h3 style={{ margin: "0px" }}>$198k</h3>
        ...
        <div className="col-md-3  stats2  rounded-5 ">
             <div className=" col-md-12 p-3 d-flex gap-2 justify-content-between align-items-center">
              <div>
             <h5 style={{fontWeight: "lighter", fontSize:"14px" }}>Earning</h5>
              <h3 style={{ margin: "0px" }}>$198k</h3>
              <h7 style={{ margin: "0px", fontSize:"13px" }}>27% increase</h7>
              </div>
            <div>
            <img src="./person.jpg" alt="Not found" width={150} height={120}></img>
            </div>
            </div> 
        </div>
      </div>
    ...
    <div className="col-12">
      <Calendar className="reactCalendar" onChange={onChange} value={date}>
      </Calendar>
      </div>
    </div>
    </div>
      ...
      <div className="col-12 gap-2 d-flex justify-content-center mt-3 ms-5 align-items-center">
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faQrcode} />
        <p className="m-0 text-white">Dashboard</p>
        </div>
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faUsers} />
        <p className="m-0 text-white">Customers</p>
        </div>
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faWrench} />
        <p className="m-0 text-white">Repairs</p>
        </div>
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faCalendarCheck} />
        <p className="m-0 text-white">Appointments</p>
        </div>
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faTruck} />
      ...
      <div className="col-12 mb-2 mt-2 gap-2 d-flex justify-content-center ms-5 align-items-center">
        ...
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faMobileScreenButton} />
        <p className="m-0 text-white">Devices</p>
        </div>
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faCartFlatbed} />
        <p className="m-0 text-white">Inventory</p>
        </div>
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon style={{color:"white"}} className="fa-2xl" icon={faFilePdf} />
        ...
        <div style={{width:"140px"}} className="tabs p-3 text-center rounded-2">
        <FontAwesomeIcon className="fa-2xl" icon={faBitcoinSign} style={{color: "#EFA23A",}} />
